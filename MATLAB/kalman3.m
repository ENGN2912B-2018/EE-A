...
% Script for displaying results of Kalamn Filter for 3 variable state
...
figure, plot(t, obv(1:size(kfilt, 1),1), t, kfilt(:,1));
title('acceleration-x');
xlabel('time');
legend('observation', 'kalman');
figure, plot(t, obv(1:size(kfilt, 1),2), t, kfilt(:,2));
title('acceleration-y');
xlabel('time');
legend('observation', 'kalman');
figure, plot(t, obv(1:size(kfilt, 1),3), t, kfilt(:,3));
title('acceleration-z');
xlabel('time');
legend('observation', 'kalman');
